...
| A RED-commit line in the implementation log template | `.ai/skills/implementation/template/log.md` | red-green-evidence REV-020 | "## RED commit" followed by the hash of the commit in which the failing test was added alone |
